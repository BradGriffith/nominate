<template>
    <div class="min-h-screen bg-gray-100" :class="{loggedin: $page.user}">
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link href="/dashboard" :active="$page.currentRouteName == 'dashboard'" v-if="$page.user">
                                Dashboard
                            </jet-nav-link>
                            ...
                            <a href="/admin" v-if="$page.user" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                Admin
                            </a>
                        </div>
                    </div>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="flex items-center ml-6" v-if="!$page.user">
                        <div class="ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                <template #trigger>
                                    <jet-dropdown-link href="/login">
                    ...
                    <div class="flex items-center px-4" v-if="$page.user">
                    ...
                    <div class="mt-3 space-y-1" v-if="$page.user">
