                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <jet-nav-link href="/" :active="$page.currentRouteName == 'dashboard'" v-if="$page.auth.user && $page.auth.user.id">
                                Dashboard
                            </jet-nav-link>
                    ...
                    <!-- Settings Dropdown -->
                    <div class="sm:flex sm:items-center sm:ml-6" v-if="!$page.user">
